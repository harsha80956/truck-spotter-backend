...
class Command(BaseCommand):
    ...
    def create_locations(self, num=10):
    ...
    def create_trips(self, locations, num=5):
        """Create random trips"""
        trips = []
        ...
        for i in range(num):
            ...
            self.stdout.write(self.style.SUCCESS(f"Created segment: {drive_segment_1}"))
            ...
            self.stdout.write(self.style.SUCCESS(f"Created segment: {loading_segment}"))
            ...
            self.stdout.write(self.style.SUCCESS(f"Created segment: {drive_segment_2}"))
            ...
            self.stdout.write(self.style.SUCCESS(f"Created segment: {unloading_segment}"))
            ...
            for day in range(day_count):
                ...
                self.stdout.write(self.style.SUCCESS(f"Created daily log: {daily_log}"))
                ...
                for _ in range(entry_count):
                    ...
                    self.stdout.write(self.style.SUCCESS(f"Created log entry: {log_entry}"))
    ...
    def handle(self, *args, **options):
        ...
        # Create new data
        locations = self.create_locations(15)
        trips = self.create_trips(locations, 10)
